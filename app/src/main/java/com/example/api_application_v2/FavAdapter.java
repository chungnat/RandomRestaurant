...
public class FavAdapter extends RecyclerView.Adapter<FavAdapter.MyViewHolder> {
    ...
    public FavAdapter(Context mContext, ArrayList<String> favRestaurantList,  ArrayList<Float> favRatingList,  ArrayList<String> favUrlList) {
        ...
        if(sharedPref.contains("blkRestaurantList")) {
            ...
            if (!blkRestaurantJson.equals("null")) {
                blkRestaurantList = gson.fromJson(blkRestaurantJson, new TypeToken<ArrayList<String>>() {
                }.getType());
            }
            if (!blkRatingJson.equals("null")) {
                blkRatingList = gson.fromJson(blkRatingJson, new TypeToken<ArrayList<Float>>() {
                }.getType());
            }
            if (!blkUrlJson.equals("null")) {
                blkUrlList = gson.fromJson(blkUrlJson, new TypeToken<ArrayList<String>>() {
                }.getType());
            }
        }
        this.favRestaurantList = favRestaurantList;
        this.favRatingList = favRatingList;
        this.favUrlList = favUrlList;
        names = (ArrayList<String>) favRestaurantList.clone();
        ratings = (ArrayList<Float>) favRatingList.clone();
        images = (ArrayList<String>) favUrlList.clone();
    }
